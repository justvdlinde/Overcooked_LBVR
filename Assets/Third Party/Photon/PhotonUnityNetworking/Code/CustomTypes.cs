...
namespace Photon.Pun
{
    ...
    internal static class CustomTypes
    {
        ...
        internal static void Register()
        {
            ...
            PhotonPeer.RegisterType(typeof(PhotonNetworkedPlayer), (byte) 'P', SerializePhotonPlayer, DeserializePhotonPlayer);
        }
        ...
        {
            int ID = ((PhotonNetworkedPlayer) customobject).ActorNumber;
        ...
        private static object DeserializePhotonPlayer(StreamBuffer inStream, short length)
        {
            ...
            {
                PhotonNetworkedPlayer player = PhotonNetwork.CurrentRoom.GetPlayer(ID);
                return player;
            }
            return null;
        }
