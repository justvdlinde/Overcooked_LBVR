...
namespace Photon.Pun
{
    ...
    public interface IPunOwnershipCallbacks
    {
        ...
        void OnOwnershipRequest(PhotonView targetView, PhotonNetworkedPlayer requestingPlayer);
        ...
        void OnOwnershipTransfered(PhotonView targetView, PhotonNetworkedPlayer previousOwner);
    }
    ...
    public class MonoBehaviourPunCallbacks : MonoBehaviourPun, IConnectionCallbacks , IMatchmakingCallbacks , IInRoomCallbacks, ILobbyCallbacks, IWebRpcCallback
    {
        ...
        /// </remarks>
        public virtual void OnMasterClientSwitched(PhotonNetworkedPlayer newMasterClient)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerEnteredRoom(PhotonNetworkedPlayer newPlayer)
        {
        }
        ...
        /// </remarks>
        public virtual void OnPlayerLeftRoom(PhotonNetworkedPlayer otherPlayer)
        {
        }
        ...
        public virtual void OnPlayerPropertiesUpdate(PhotonNetworkedPlayer targetPlayer, Hashtable changedProps)
        {
        }
    ...
    public struct PhotonMessageInfo
    {
        ...
        public readonly PhotonNetworkedPlayer Sender;
        public readonly PhotonView photonView;

        public PhotonMessageInfo(PhotonNetworkedPlayer player, int timestamp, PhotonView view)
        {
            this.Sender = player;
    ...
    public class PhotonStream
    {
        ...
        /// Will read or write the value, depending on the stream's IsWriting value.
        /// </summary>
        public void Serialize(ref PhotonNetworkedPlayer obj)
        {
            if (this.IsWriting)
            {
                this.writeData.Add(obj);
            ...
            else
            {
                if (this.readData.Length > this.currentItem)
                {
                    obj = (PhotonNetworkedPlayer) this.readData[this.currentItem];
                    this.currentItem++;
                }
            }
        }
