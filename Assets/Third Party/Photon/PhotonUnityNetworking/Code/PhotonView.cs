...
namespace Photon.Pun
{
    ...
    public class PhotonView : MonoBehaviour
    {
        ...
        /// The current owner has to implement IPunCallbacks.OnOwnershipRequest to react to the ownership request.
        /// </remarks>
        public PhotonNetworkedPlayer Owner
        {
            get
            {
                // TODO cache Owner
        ...
        public PhotonNetworkedPlayer Controller
        {
            get
            {
                // TODO cache Owner
        ...
        /// The owner/controller of a PhotonView is also the client which sends position updates of the GameObject.
        /// </remarks>
        public void TransferOwnership(PhotonNetworkedPlayer newOwner)
        {
        ...
        /// <param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RPC(string methodName, PhotonNetworkedPlayer targetPlayer, params object[] parameters)
        {
        ...
        ///<param name="encrypt"> </param>
        ///<param name="parameters">The parameters that the RPC method has (must fit this call!).</param>
        public void RpcSecure(string methodName, PhotonNetworkedPlayer targetPlayer, bool encrypt, params object[] parameters)
        {
