...
namespace Photon.Pun
{
    ...
    public struct InstantiateParameters
    {
        ...
        public PhotonNetworkedPlayer creator;
        public int timestamp;

        public InstantiateParameters(string prefabName, Vector3 position, Quaternion rotation, byte @group, object[] data, byte objLevelPrefix, int[] viewIDs, PhotonNetworkedPlayer creator, int timestamp)
        {
    ...
    {
		public static Action OnPhotonAutoSyncSceneEvent = null;
        ...
        /// </remarks>
        public static PhotonNetworkedPlayer LocalPlayer
        {
            get
            {
                if (NetworkingClient == null)
        ...
        /// </summary>
        public static PhotonNetworkedPlayer[] PlayerList
        {
            get
            {
                ...
                return new PhotonNetworkedPlayer[0];
            }
        }
        ...
        /// </summary>
        public static PhotonNetworkedPlayer[] PlayerListOthers
        {
            get
            {
                Room room = CurrentRoom;
        ...
        /// </remarks>
        public static PhotonNetworkedPlayer MasterClient
        {
            get
            {
                if (OfflineMode)
        ...
        public static bool ConnectToCloud()
        {
            if (NetworkingClient.LoadBalancingPeer.PeerState != PeerStateValue.Disconnected)
            {
                Debug.LogWarning("ConnectToCloud() failed. Can only connect while in state 'Disconnected'. Current state: " + NetworkingClient.LoadBalancingPeer.PeerState);
                return false;
            }
            if (PhotonHandler.AppQuits)
            {
        ...
        // Ugly copy paste of Disconnect() that allows for selecting a DisconnectCause
        public static void Disconnect(DisconnectCause cause)
        {
            if (OfflineMode)
            {
                OfflineMode = false;
            ...
            NetworkingClient.Disconnect(cause);
        }
        ...
        public static bool CloseConnection(PhotonNetworkedPlayer kickPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return false;
        ...
        public static bool SetMasterClient(PhotonNetworkedPlayer masterClientPlayer)
        {
        ...
        private static GameObject NetworkInstantiate(Hashtable networkEvent, PhotonNetworkedPlayer creator)
        {
        ...
        /// </remarks>
        /// <returns>Nothing. Check error debug log for any issues.</returns>
        public static void DestroyPlayerObjects(PhotonNetworkedPlayer targetPlayer)
        {
        ...
        public static void RemoveRPCs(PhotonNetworkedPlayer targetPlayer)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
        ...
        /// Internal to send an RPC on given PhotonView. Do not call this directly but use: PhotonView.RPC!
        /// </summary>
        internal static void RPC(PhotonView view, string methodName, PhotonNetworkedPlayer targetPlayer, bool encrpyt, params object[] parameters)
        {
            if (!VerifyCanUseNetwork())
            {
                return;
        ...
        public static void LoadLevel(int levelNumber)
        {
            ...
            {
				if(OnPhotonAutoSyncSceneEvent != null)
					OnPhotonAutoSyncSceneEvent.Invoke();
