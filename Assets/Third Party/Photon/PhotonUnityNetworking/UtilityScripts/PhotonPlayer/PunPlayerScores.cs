...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        public static void SetScore(this PhotonNetworkedPlayer player, int newScore)
        {
        ...
        public static void AddScore(this PhotonNetworkedPlayer player, int scoreToAddToCurrent)
        {
        ...
        public static int GetScore(this PhotonNetworkedPlayer player)
        {
            object score;
