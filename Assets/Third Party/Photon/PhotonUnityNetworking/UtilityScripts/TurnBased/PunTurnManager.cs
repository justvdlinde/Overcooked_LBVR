...
namespace Photon.Pun.UtilityScripts
{
	...
	public class PunTurnManager : MonoBehaviourPunCallbacks, IOnEventCallback
    {
        ...
        /// </summary>
        private readonly HashSet<PhotonNetworkedPlayer> finishedPlayers = new HashSet<PhotonNetworkedPlayer>();
        ...
        public bool GetPlayerFinishedTurn(PhotonNetworkedPlayer player)
        {
		...
		{
			PhotonNetworkedPlayer sender = PhotonNetwork.CurrentRoom.GetPlayer(senderId);
			switch (eventCode)
			{
			case EvMove:
				{
    ...
    public interface IPunTurnManagerCallbacks
    {
        ...
        void OnPlayerMove(PhotonNetworkedPlayer player, int turn, object move);
        ...
        /// <param name="turn">Turn index</param>
        /// <param name="move">Move Object data</param>
        void OnPlayerFinished(PhotonNetworkedPlayer player, int turn, object move);
    ...
    public static class TurnExtensions
    {
        ...
        /// <param name="player">Player reference</param>
        public static int GetFinishedTurn(this PhotonNetworkedPlayer player)
        {
        ...
        /// <param name="player">Player Reference</param>
        /// <param name="turn">Turn Index</param>
        public static void SetFinishedTurn(this PhotonNetworkedPlayer player, int turn)
        {
            Room room = PhotonNetwork.CurrentRoom;
            if (room == null || room.CustomProperties == null)
            {
