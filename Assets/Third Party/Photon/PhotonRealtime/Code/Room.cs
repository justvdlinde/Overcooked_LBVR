...
namespace Photon.Realtime
{
    ...
    public class Room : RoomInfo
    {
        ...
        private Dictionary<int, PhotonNetworkedPlayer> players = new Dictionary<int, PhotonNetworkedPlayer>();

        /// <summary>While inside a Room, this is the list of players who are also in that room.</summary>
        public Dictionary<int, PhotonNetworkedPlayer> Players
        {
            get
            {
                return this.players;
        ...
        /// </summary>
        protected internal virtual void RemovePlayer(PhotonNetworkedPlayer player)
        {
        ...
        public bool SetMasterClient(PhotonNetworkedPlayer masterClientPlayer)
        {
        ...
        public virtual bool AddPlayer(PhotonNetworkedPlayer player)
        {
        ...
        public virtual PhotonNetworkedPlayer StorePlayer(PhotonNetworkedPlayer player)
        {
        ...
        public virtual PhotonNetworkedPlayer GetPlayer(int id)
        {
            PhotonNetworkedPlayer result = null;
