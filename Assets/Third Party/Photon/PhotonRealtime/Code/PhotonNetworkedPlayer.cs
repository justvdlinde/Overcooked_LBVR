...
namespace Photon.Realtime
{
    ...
    /// </remarks>
    public class PhotonNetworkedPlayer
    {
        /// <summary>
        ...
        protected internal PhotonNetworkedPlayer(string nickName, int actorNumber, bool isLocal) : this(nickName, actorNumber, isLocal, null)
        {
        }
        ...
        protected internal PhotonNetworkedPlayer(string nickName, int actorNumber, bool isLocal, Hashtable playerProperties)
        {
        ...
        public PhotonNetworkedPlayer Get(int id)
        {
            if (this.RoomReference == null)
            {
                return null;
        ...
        /// <returns>Player or null.</returns>
        public PhotonNetworkedPlayer GetNext()
        {
        ...
        /// <returns>Player or null.</returns>
        public PhotonNetworkedPlayer GetNextFor(PhotonNetworkedPlayer currentPlayer)
        {
        ...
        /// <returns>Player or null.</returns>
        public PhotonNetworkedPlayer GetNextFor(int currentPlayerId)
        {
            ...
            Dictionary<int, PhotonNetworkedPlayer> players = this.RoomReference.Players;
        ...
        {
            PhotonNetworkedPlayer pp = p as PhotonNetworkedPlayer;
