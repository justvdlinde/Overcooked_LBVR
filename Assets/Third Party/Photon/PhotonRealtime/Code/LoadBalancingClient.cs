...
namespace Photon.Realtime
{
    ...
    public enum DisconnectCause
    {
        ...
        /// <summary>Client was unable to find a server using UDPServerDiscovery.</summary>
        ServerUDPSearchTimeout,
        /// <summary>Game version does not match with master client.</summary>
        GameVersionMismatch,
        /// <summary>Max operator count reached. </summary>
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        public PhotonNetworkedPlayer LocalPlayer { get; internal set; }
        ...
        protected internal bool OpSetPropertiesOfActor(int actorNr, Hashtable actorProperties, Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ...
            {
                PhotonNetworkedPlayer target = this.CurrentRoom.GetPlayer(actorNr);
                if (target != null)
                {
        ...
        private void ReadoutProperties(Hashtable gameProperties, Hashtable actorProperties, int targetActorNr)
        {
            ...
            if (actorProperties != null && actorProperties.Count > 0)
            {
                if (targetActorNr > 0)
                {
                    ...
                    PhotonNetworkedPlayer target = this.CurrentRoom.GetPlayer(targetActorNr);
                    if (target != null)
                    {
        ...
        private void UpdatedActorList(int[] actorsInGame)
        {
            if (actorsInGame != null)
            {
                ...
                {
                    PhotonNetworkedPlayer target = this.CurrentRoom.GetPlayer(userId);
                    if (target == null)
                    {
        ...
        protected internal virtual PhotonNetworkedPlayer CreatePlayer(string actorName, int actorNumber, bool isLocal, Hashtable actorProperties)
        {
            PhotonNetworkedPlayer newPlayer = new PhotonNetworkedPlayer(actorName, actorNumber, isLocal, actorProperties);
            return newPlayer;
        }
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            ...
            PhotonNetworkedPlayer originatingPlayer = (this.CurrentRoom != null) ? this.CurrentRoom.GetPlayer(actorNr) : null;
    ...
    public interface IInRoomCallbacks
    {
        ...
        /// </remarks>
        void OnPlayerEnteredRoom(PhotonNetworkedPlayer newPlayer);
        ...
        /// </remarks>
        void OnPlayerLeftRoom(PhotonNetworkedPlayer otherPlayer);
        ...
        void OnPlayerPropertiesUpdate(PhotonNetworkedPlayer targetPlayer, Hashtable changedProps);
        ...
        /// </remarks>
        void OnMasterClientSwitched(PhotonNetworkedPlayer newMasterClient);
    }
    ...
    public class MatchMakingCallbacksContainer : List<IMatchmakingCallbacks>, IMatchmakingCallbacks
    {
        ...
        public void OnCreateRoomFailed(short returnCode, string message)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                this[i].OnCreateRoomFailed(returnCode, message);
            }
        }
        ...
        public void OnJoinRandomFailed(short returnCode, string message)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                this[i].OnJoinRandomFailed(returnCode, message);
            }
        }
        ...
        public void OnJoinRoomFailed(short returnCode, string message)
        {
            ...
            for (int i = 0; i < Count; i++)
            {
                this[i].OnJoinRoomFailed(returnCode, message);
            }
        }
    ...
    internal class InRoomCallbacksContainer : List<IInRoomCallbacks>, IInRoomCallbacks
    {
        ...
        public void OnPlayerEnteredRoom(PhotonNetworkedPlayer newPlayer)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnPlayerLeftRoom(PhotonNetworkedPlayer otherPlayer)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnPlayerPropertiesUpdate(PhotonNetworkedPlayer targetPlayer, Hashtable changedProp)
        {
            this.client.UpdateCallbackTargets();
        ...
        public void OnMasterClientSwitched(PhotonNetworkedPlayer newMasterClient)
        {
            this.client.UpdateCallbackTargets();
